...
const baseFilePath = config.nodeEnv === "production" ? path.resolve(process.cwd(), "/../tmp") : path.join(__dirname, CONSTANTS.FILE_BASEPATH);
console.log(process.cwd(), path.resolve(process.cwd(), "/../tmp"))
